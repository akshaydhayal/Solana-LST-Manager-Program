...
pub enum InstructionType{
    ...
    UnstakeSOLFromValidator{stake_acc_index:u64, lst_manager_bump:u8, lst_manager_vault_bump:u8, epoch_withdraw_bump:u8, stake_acc_bump:u8, split_stake_acc_bump:u8, stake_registry_record_bump:u8}, // by admin
