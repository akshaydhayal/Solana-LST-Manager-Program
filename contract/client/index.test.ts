import { clusterApiUrl, Connection, Keypair, LAMPORTS_PER_SOL, PublicKey, StakeProgram, SystemProgram, SYSVAR_RENT_PUBKEY, Transaction, TransactionInstruction } from "@solana/web3.js";
...
describe("lst manager tests",()=>{
    ...
    beforeAll(async()=>{
        ...
        lst_manager_prog=new PublicKey("6xU8Pb6ZoV9UfPXhKCWHeiuR9hSRXtFmQKdAkPVuXrM6");
    ...
    it("stake vault test",async()=>{
        ...
        console.log("stake acc : ",stake_acc.publicKey.toBase58());
        let ix=new TransactionInstruction({
            programId:lst_manager_prog,
            keys:[
                {pubkey:user.publicKey, isSigner:true, isWritable:false},
